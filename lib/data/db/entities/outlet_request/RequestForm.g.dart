...
part of 'RequestForm.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RequestForm _$RequestFormFromJson(Map<String, dynamic> json) {
  return RequestForm()
    ...
    ..pjPs = (jsonDecode(json['pjPs']) as List<dynamic>?)
        ...
        .toList()
    ..isPJPFixed = boolFromInt(json['isPJPFixed'] as int?)
...
Map<String, dynamic> _$RequestFormToJson(RequestForm instance) =>
    <String, dynamic>{
